...
<head>
    ...
    <style>
        body { padding-top: 55px; scroll-behavior: smooth;} /* Sesuaikan dengan tinggi navbar */
        .hero {
            background: url('https://images.unsplash.com/photo-1503220317375-aaad61436b1b?ixlib=rb-4.0.3') no-repeat center center;
